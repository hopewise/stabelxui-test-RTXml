...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Stablexui", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Stablexui", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Stablexui";
		app.meta["name"] = "Stablexui";
		app.meta["packageName"] = "com.sample.stablexui";
